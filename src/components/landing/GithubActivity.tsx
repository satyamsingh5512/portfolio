...
import type { ContributionsPayload } from "@/app/api/github-contributions/route";
...
function ContributionCalendar({
  ...
  return (
    <div
      ...
      role="region"
      aria-label="GitHub contribution calendar, scrollable horizontally"
      tabIndex={0}
    >
      <div className="inline-block min-w-full">
        ...
        <div className="flex">
          ...
          <div
            ...
            role="img"
            aria-label={`GitHub contribution calendar for the past year across ${weeks.length} weeks`}
          >
